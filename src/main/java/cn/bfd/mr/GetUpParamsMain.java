...
public class GetUpParamsMain {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //job configuration
        Job job = new Job(conf, "GetUpParamsForManageData");
        job.setJarByClass(GetUpParamsMain.class);
        Scan scan = new Scan();
        scan.addFamily(Bytes.toBytes(otherArgs[1]));
        scan.setCaching(1000);
        scan.setCacheBlocks(false);
        TableMapReduceUtil.initTableMapperJob(Bytes.toBytes(otherArgs[0]), scan, ManageMapper1.class, Text.class, IntWritable.class, job);
