 ...
 */
public class ManageMapper extends Mapper<LongWritable, Text, ImmutableBytesWritable, KeyValue> {
    ...
    @Override
    protected void map(LongWritable key, Text val, Mapper<LongWritable, Text, ImmutableBytesWritable, KeyValue>.Context context)
    ...
    @Override
    protected void cleanup(Mapper<LongWritable, Text, ImmutableBytesWritable, KeyValue>.Context context)
    		 {
    	if (gids.size() > 0) {
